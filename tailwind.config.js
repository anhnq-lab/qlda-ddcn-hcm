        ...
        extend: {
            colors: {
                ...
                primary: {
                    ...
                    200: '#F0D68A',
                    300: '#E4C45A',
                    400: '#D4A843', // Vàng kim sáng
                    500: '#D4A017', // Vàng kim — Main brand
                    600: '#B8860B',
                    700: '#996515',
                    800: '#7A5012',
                    900: '#5C3D0E',
                ...
                // === PRIMARY → GOLD (Ban DDCN brand color) ===
                primary: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === ORANGE → GOLD REMAP (Ban DDCN theme) ===
                orange: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === AMBER → GOLD REMAP (Ban DDCN theme) ===
                amber: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === YELLOW → GOLD REMAP (Ban DDCN theme) ===
                yellow: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === BLUE → GOLD REMAP (Ban DDCN theme) ===
                blue: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === EMERALD → GOLD REMAP (Ban DDCN theme) ===
                emerald: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === INDIGO → GOLD REMAP (Ban DDCN theme) ===
                indigo: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
                ...
                // === GREEN → GOLD-GREEN REMAP (slightly warmer) ===
                green: {
                    50: '#FEFCE8',
                    100: '#FEF7CD',
                    200: '#F0D68A',
