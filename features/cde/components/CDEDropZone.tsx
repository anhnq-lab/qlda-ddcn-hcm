        ...
        <div className="space-y-3">
            ...
            <div
                ...
                className={`relative border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all duration-200 ${disabled
                    ...
                    : isDragging
                        ? 'border-blue-400 bg-blue-50/50 dark:border-blue-500 dark:bg-blue-900/20 scale-[1.01] shadow-lg shadow-blue-100 dark:shadow-blue-900/20'
            ...
            >
                {isDragging && (
                    <div className="absolute inset-0 bg-blue-500/5 rounded-xl flex items-center justify-center z-10">
                        <div className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-lg animate-bounce">
                            Thả file tại đây
                        </div>
                    </div>
                )}
