...
export const CreatePlanForm: React.FC<CreatePlanFormProps> = ({
    ...
    const inputClass = "px-3 py-2 text-sm border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 dark:text-slate-200 focus:ring-2 focus:ring-amber-500 focus:border-amber-500";
