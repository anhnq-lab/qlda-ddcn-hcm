            ...
            <div className="flex flex-col gap-6 mb-8">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-gradient-to-r from-amber-600 to-yellow-600 text-white px-6 py-3 rounded-2xl text-sm font-black uppercase tracking-widest hover:shadow-xl hover:shadow-amber-200 transition-all transform hover:-translate-y-1"
                    >
